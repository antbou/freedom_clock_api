 ...
 */
final class Version20240314163952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer (id UUID NOT NULL, participant_id UUID DEFAULT NULL, selected_option_id UUID DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE image (id UUID NOT NULL, filename VARCHAR(255) NOT NULL, mime_type VARCHAR(255) NOT NULL, size INT NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE quiz (id UUID NOT NULL, image_id UUID DEFAULT NULL, created_by_id UUID DEFAULT NULL, title VARCHAR(255) NOT NULL, introduction VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE quiz_participant (id UUID NOT NULL, participant_id UUID DEFAULT NULL, quiz_id UUID DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN quiz_participant.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN quiz_participant.participant_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN quiz_participant.quiz_id IS \'(DC2Type:uuid)\'');
